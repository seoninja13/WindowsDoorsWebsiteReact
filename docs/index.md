# Windows Doors Website React - Documentation

This directory contains all the documentation for the Windows Doors Website React project. The documentation follows a pyramid structure with the main [README.md](../README.md) as the single entry point.
...
1. [Overview](./overview.md) - To understand the technical foundation
