...
export const Footer: React.FC<FooterProps> = ({
  columns,
  logoSrc = '/images/logo/window-world-logo-white.svg',
  logoAlt = 'Window World Logo',
  address = '1234 Main Street, Los Angeles, CA 90001',
  phoneNumber = '(310) 919-2352',
  socialLinks = [
    { platform: 'facebook', url: 'https://www.facebook.com/windowworldla' },
    { platform: 'twitter', url: 'https://twitter.com/windowworldla' },
    { platform: 'instagram', url: 'https://www.instagram.com/windowworldla/' },
    { platform: 'youtube', url: 'https://www.youtube.com/user/windowworldla' }
  ],
  copyrightText = '© 2023 Window World of Los Angeles. All Rights Reserved.',
  bottomLinks = [
